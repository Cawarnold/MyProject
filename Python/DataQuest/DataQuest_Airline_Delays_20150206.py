...
# Basics: Which airline is delayed the most? (Finding_average_delay_for_each_carrier)
...
Writing a _while loop. (Writing_a_while_loop)
Stoping a _while loop _with a _break clause. (Using_the_break_keyword)
Define function that finds a column number _from a name. (Finding_a_column_number_from_a_name)
Negative indexes get values _from the end of a _list. (Using_negative_indexing)
Negative indexes, up to end _or beginning. (Indexing_up_to_the_end_or_from_the_beginning)
Using the column_number_from_name funciton _and a _list comprehension. (Finding_the_percentage_of_delayed_flights)
Using function _and _for loop. (Finding_the_average_delay_time)
Function that takes column name _and returns column _sum. (Making_a_function_to_calculate_the_delay)
Creating functions _with multiple arguments. (Named_arguments_to_functions)
Writing functions _with optional arguments. (Optional_arguments_to_a_function)
Write function find_average_delay that takes a carrier name. (Finding_delay_by_carrier)
Create a _dict of delays by carrier. (Finding_average_delay_for_each_carrier)
...
# The loop will keep running as long as the condition specified is True.
...
print(flight_delays[-1])       # Prints the last row in flight_delays
...
print(flight_delays[-3:-1])    # Prints the rows at index -3 and -2
...
## USING the FUNCTION: column_number_from_name
...
print(multiply(5))          # This will multiply 5 * 2 * 1
print(multiply(a=6, c=4))   # This will multiply 6 * 2 * 4
...
## USING the FUNCTIONS: column_number_from_name, calc_sum_of
...
print(average_delay_time)                        # Prints average delay for all airports
print(american_airlines_average_delay_time)      # Prints average delay for specific airport
...
## USING the FUNCTIONS: column_number_from_name, find_average_delay
